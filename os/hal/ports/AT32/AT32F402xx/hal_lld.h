...
/**
 * @file    AT32F402xx/hal_lld.h
 * @brief   AT32F402xx HAL subsystem low level driver header.
 ...
 * @{
 */
#define PLATFORM_NAME                          "AT32F402xx"

/**
 * @brief   Sub-family identifier.
 */
#if !defined(AT32F402xx) || defined(__DOXYGEN__)
#define AT32F402xx
#endif
/** @} */
...
#define AT32_LDOOVSEL_1P0V          (1 << 0)   /**< LDOOVSEL 1.1V. not use 1.0V*/
 ...
 */
#if !defined(AT32F402xx_MCUCONF)
#error "Using a wrong mcuconf.h file, AT32F402xx_MCUCONF not defined"
#endif
