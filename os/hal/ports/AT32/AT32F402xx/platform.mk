...
PLATFORMSRC_CONTRIB += $(CHIBIOS)/os/hal/ports/common/ARMCMx/nvic.c \
                       $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F402xx/hal_lld.c \
			           $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F402xx/at32_isr.c \
                       $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F402xx/hal_efl_lld.c

# Required include directories.
PLATFORMINC_CONTRIB += $(CHIBIOS)/os/hal/ports/common/ARMCMx \
               $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F402xx
