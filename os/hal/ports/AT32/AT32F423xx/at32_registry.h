...
/*===========================================================================*/
#if defined(AT32F423Tx) || defined(AT32F423Kx) || defined(__DOXYGEN__)
/**
...
/* EDMA attributes.*/
#define AT32_EDMA_SUPPORTS_EDMAMUX          FALSE
#define AT32_HAS_EDMA1                      FALSE
...
#define AT32_FLASH_SECTORS_PER_BANK         64 /* Maximum, can be redefined.*/
#else 
...
#define AT32_HAS_SPI4                       FALSE
#define AT32_SPI4_SUPPORTS_I2S              FALSE
#define AT32_SPI4_I2S_FULLDUPLEX            FALSE

/* QUADSPI attributes.*/
#define AT32_HAS_QUADSPI1                   FALSE
#define AT32_HAS_QUADSPI2                   FALSE
...
#define AT32_TMR5_IS_32BITS                 FALSE
...
#if defined(AT32F423Cx) || defined(__DOXYGEN__)
/**
 * @name    AT32F423Cx capabilities
 * @{
 */
...
#if defined(AT32F423Rx) || defined(__DOXYGEN__)
/**
 * @name    AT32F423Rx capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                       TRUE
...
#if defined(AT32F423Vx) || defined(__DOXYGEN__)
/**
