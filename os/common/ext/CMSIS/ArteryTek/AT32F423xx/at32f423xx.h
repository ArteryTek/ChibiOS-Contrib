...
{                                                   /*!< ADC Structure                                                         */
  ...
  __IO uint32_t  SPT3;                              /*!< sample time register 3                                                */
  __IO uint32_t  OSQ4;                              /*!< Ordinary sequence register 4                                          */
  __IO uint32_t  OSQ5;                              /*!< Ordinary sequence register 5                                          */
  __IO uint32_t  OSQ6;                              /*!< Ordinary sequence register 6                                          */
...
typedef struct
{                                                   /*!< ADCCOM Structure                                                      */
  __IO uint32_t  RESERVED0;                         /*!< Common status register                                                */
...
{                                                   /*!< ERTC Structure                                                        */
  ...
  __IO uint32_t  RESERVEDX;                              /*!< Calibration register                                                  */
...
{                                                   /*!< GPIO Structure                                                       */
  ...
  __IO uint32_t  TOGR;                              /*!< GPIO toggle register                                               */
...
#define CRM_CTRL_HICKCAL                 (0xFFU << 8)
...
#define CRM_PLLCFG_PLLRCS                (0x1U << 22)
...
#define CRM_AHBLPEN1_FLASHLPEN           (0x1U << 15)
#define CRM_AHBLPEN1_SRAMLPEN            (0x1U << 16)
...
/*****************  Bit definition for CRM_APB2LPEN register  ***************/
#define CRM_PICLKS_USART1SEL_MSK         (0x3U << 0)
#define CRM_PICLKS_USART1SEL_PCLK2       (0x0U << 0)
#define CRM_PICLKS_USART1SEL_SCLK        (0x1U << 0)
#define CRM_PICLKS_USART1SEL_HICK        (0x2U << 0)
#define CRM_PICLKS_USART1SEL_LEXT        (0x3U << 0)
#define CRM_PICLKS_USART2SEL_MSK         (0x3U << 2)
#define CRM_PICLKS_USART2SEL_PCLK2       (0x0U << 2)
#define CRM_PICLKS_USART2SEL_SCLK        (0x1U << 2)
#define CRM_PICLKS_USART2SEL_HICK        (0x2U << 2)
#define CRM_PICLKS_USART2SEL_LEXT        (0x3U << 2)
#define CRM_PICLKS_USART3SEL_MSK         (0x3U << 4)
#define CRM_PICLKS_USART3SEL_PCLK2       (0x0U << 4)
#define CRM_PICLKS_USART3SEL_SCLK        (0x1U << 4)
#define CRM_PICLKS_USART3SEL_HICK        (0x2U << 4)
#define CRM_PICLKS_USART3SEL_LEXT        (0x3U << 4)
#define CRM_PICLKS_I2C1SEL_MSK           (0x3U << 12)
#define CRM_PICLKS_I2C1SEL_PCLK2         (0x0U << 12)
#define CRM_PICLKS_I2C1SEL_SCLK          (0x1U << 12)
#define CRM_PICLKS_I2C1SEL_HICK          (0x2U << 12)
...
#define FLASH_CTRL_USDULKS               (0x1U << 9)
#define FLASH_CTRL_ERRIE                 (0x1U << 10)
#define FLASH_CTRL_ODFIE                 (0x1U << 12)
